...
export default function ReportsPage() {
 ...
 <button className="flex items-center gap-2 bg-white border border-slate-200 text-slate-700 px-4 py-2 rounded-lg text-sm font-medium hover:bg-slate-50 :bg-slate-700 transition shadow-sm">
 ...
 <h3 className="text-lg font-bold text-slate-900 mb-2">Daily Governance Brief - 20 May 2025</h3>
 ...
 <div>
 <div className="text-2xl font-bold text-slate-900 ">1,213</div>
 ...
 <div>
 <div className="text-2xl font-bold text-slate-900 ">48.7%</div>
 ...
 <div>
 <div className="text-2xl font-bold text-slate-900 ">2.6 Days</div>
 ...
 <div key={i} className="border border-slate-100 rounded-xl p-4 hover:border-slate-300 :border-slate-600 transition cursor-pointer group">
 ...
 <div className={`w-4 h-4 rounded border flex items-center justify-center ${item.checked ? 'bg-blue-600 border-blue-600 text-white' : 'bg-white border-slate-300 group-hover:border-blue-500'}`}>
 ...
 <select className="bg-slate-50 border border-slate-200 text-sm rounded-lg px-3 py-2 text-slate-700 focus:outline-none focus:ring-1 focus:ring-blue-500 flex-1">
 <option>Custom Range</option>
 <option>Last 30 Days</option>
 <option>This Month</option>
 </select>
 <div className="flex items-center gap-2 bg-slate-50 border border-slate-200 text-sm rounded-lg px-3 py-2 flex-[2]">
 <span className="text-slate-600 ">01 May 2025</span>
 <span className="text-slate-400">to</span>
 <span className="text-slate-600 ">20 May 2025</span>
 ...
 <textarea 
 className="w-full h-32 bg-slate-50 border border-slate-200 rounded-xl p-4 text-sm text-slate-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 resize-none mb-4"
 ...
 <tr key={i} className="hover:bg-slate-50 :bg-slate-800/40 transition-colors">
