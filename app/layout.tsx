  ...
  return (
    ...
    >
      ...
      <body className="flex h-screen w-screen overflow-hidden bg-[#F8FAFC] text-[#0F172A] font-[family-name:var(--font-inter)]">
        ...
        <ErrorBoundary
          fallback={
            <div className="flex h-full items-center justify-center bg-[#F5F0E9] dark:bg-[#0a0a0a]">
        ...
        >
          <Sidebar />
          <main className="flex-1 flex flex-col h-full overflow-hidden transition-all duration-300 relative bg-[#F8FAFC] dark:bg-[#0a0a0a]">
